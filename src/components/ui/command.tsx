...
function CommandInput({
	...
	return (
		<div
			...
			className="flex h-9 items-center gap-2 border-b border-input-border px-3"
		>
...
function CommandList({
	...
	return (
		<CommandPrimitive.List
			...
			className={cn(
				"w-full scroll-py-1 overflow-x-hidden overflow-y-auto max-h-[8rem]",
				className
			)}
			{...props}
		/>
...
function CommandItem({
	...
	return (
		<CommandPrimitive.Item
			...
			className={cn(
				"cursor-pointer data-[selected=true]:bg-neutral-100 data-[selected=true]:text-neutral-900 [&_svg:not([class*='text-'])]:text-neutral-500 relative flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:data-[selected=true]:bg-neutral-800 dark:data-[selected=true]:text-neutral-50 dark:[&_svg:not([class*='text-'])]:text-neutral-400",
				className
			)}
			{...props}
		/>
