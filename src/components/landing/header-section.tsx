...
export default function HeaderSection(props: HeaderSectionProps) {
  ...
  return (
    <div className="w-full flex justify-between place-items-center pt-8">
      ...
      <div className="flex place-items-center sm:space-x-4 space-x-3">
        <Dialog>
        ...
        {props.session ? (
          <Link
            ...
            className="hover:text-highlight font-medium sm:text-base text-sm duration-150"
          >
            Home
          </Link>
        ) : (
          <button
            className="hover:text-highlight font-medium duration-150 sm:text-base text-sm cursor-pointer"
            onClick={() =>
