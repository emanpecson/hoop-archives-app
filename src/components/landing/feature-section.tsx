...
export default function FeatureSection(props: FeatureSectionProps) {
  return (
    <section className="space-y-2">
      ...
      <div className="flex px-2 lg:space-x-2 lg:justify-start justify-evenly">
        {appFeatures.map((feat, i) => (
          ...
          >
            ...
            <span className="sm:text-base text-xs">{feat.label}</span>
          </button>
        ))}
      </div>
      ...
      <div
        className={cn(
          "rounded-2xl border p-4 inset-shadow-sm font-light h-full relative sm:pb-32",
      ...
      >
        ...
        <button className="sm:absolute hidden z-10 -bottom-5 right-16">
          <Link
